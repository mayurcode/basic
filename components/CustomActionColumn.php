    ...
    protected function initDefaultButtons()
    {
        if (!isset($this->buttons['view'])) {
            $this->buttons['view'] = function ($url, $model, $key) {
                return Html::a('<span class="fa fa-search" style="color:white;font-weight:bold;"></span>', $url, [
        ...
        if (!isset($this->buttons['update'])) {
            $this->buttons['update'] = function ($url, $model, $key) {
                return Html::a('<span class="fa fa-pencil-square-o" style="color:white;font-weight:bold;"></span>', $url, [
        ...
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function ($url, $model, $key) {
                return Html::a('<span class="fa fa-times" style="color:white;font-weight:bold;"></span>', $url, [
